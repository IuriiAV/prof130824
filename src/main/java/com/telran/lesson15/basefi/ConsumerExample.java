...
import com.telran.lesson15.Student2;
...
public class ConsumerExample {
    ...
    public static void main(String[] args) {
        ...
        Consumer<Student2> studentInfoPrinter = (student) -> System.out.println("Name :" + student.getName()+ " Age:"+ student.getAge());
        studentInfoPrinter.accept(new Student2("Alex", 50));
